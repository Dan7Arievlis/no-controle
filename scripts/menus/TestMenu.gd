...
#region Movement Page
	...
	create_toggle_button("Habilitar movimento", MOVEMENT_STATS, "enable_movement", movement_page)
...
#region Acceleration page
	...
	create_simple_slider("Taxa de aceleração", 0, 20, 0.1, MOVEMENT_STATS, "accel_rate", acceleration_page,
		"Influencia o tempo para alcançar a velocidade máxima enquanto estiver no chão.")
	create_simple_slider("Taxa de desaceleração", 0, 20, 0.1, MOVEMENT_STATS, "decel_rate", acceleration_page,
		"Influencia o tempo para se manter estacionário enquanto estiver no chão.")
	create_simple_slider("Taxa de aceleração no ar", 0, 20, 0.1, MOVEMENT_STATS, "air_accel_rate", acceleration_page,
		"Influencia o tempo para alcançar a velocidade máxima enquanto estiver no ar.")
	create_simple_slider("Taxa de desaceleração no ar", 0, 20, 0.1, MOVEMENT_STATS, "air_decel_rate", acceleration_page,
		"Influencia o tempo para se manter estacionário enquanto estiver no ar.")
	create_simple_slider("Desaceleração de altas velocidades", 0, 20, 0.1, MOVEMENT_STATS, "high_speed_decel", acceleration_page,
		"Influencia o tempo para restaurar a velocidade máxima após excedê-la enquanto estiver no chão.")
	create_simple_slider("Desaceleração de altas velocidades no ar", 0, 20, 0.1, MOVEMENT_STATS, "air_high_speed_decel", acceleration_page,
...
#region Speed Page
	...
	create_simple_slider("Velocidade de caminhada", 30, 300, 0.1, MOVEMENT_STATS, "walk_speed", speed_page)
	create_simple_slider("Velocidade de virada", 0, 20, 0.1, MOVEMENT_STATS, "turn_speed", speed_page,
		"Influencia no tempo para que a direção de movimento se iguale à direção do input enquanto no chão.")
	create_simple_slider("Velocidade de virada no ar", 0, 20, 0.1, MOVEMENT_STATS, "air_turn_speed", speed_page, 
	...
	create_trigger("can_run", create_toggle_button("Pode correr", MOVEMENT_STATS, "can_run", speed_page))
	create_observer("can_run", create_simple_slider("Velocidade de corrida", 200, 600, 0.1, MOVEMENT_STATS, "run_speed", speed_page))
#endregion
#endregion
...
#region Jump Page
	...
	create_toggle_button("Habilitar pulo", JUMP_STATS, "enable_jump", jump_page)
...
#region Impulses
	...
	create_simple_slider("Velocidade do pulo", 10, 1000, 1, JUMP_STATS, "jump_velocity", impulses_page,
		"Influencia na altura máxima que um pulo poderá alcançar")
	create_label("Coyote Time e Buffer de Pulo", impulses_page)
	create_simple_slider("Coyote Time", 0, 0.3, 0.02, JUMP_STATS, "coyote_time", impulses_page,
		"Determina o tempo, em segundos, que a ação de pulo pode ser identificada como input mesmo após o personagem deixar o chão.")
	create_simple_slider("Buffer de tempo", 0, 0.3, 0.02, JUMP_STATS, "jump_buffer", impulses_page,
	...
	create_trigger("double_jump", create_toggle_button("Pode dar pulo duplo", JUMP_STATS, "double_jump", impulses_page))
	create_observer("double_jump", create_simple_slider("Velocidade de pulo duplo", 10, 800, 2, JUMP_STATS, "double_jump_velocity", impulses_page,
		"Influencia na altura máxima que um segundo pulo executado no ar poderá alcançar."))
	create_observer("double_jump", create_simple_slider("Espera para pulo", 0, 0.5, 0.01, JUMP_STATS, "jump_wait", impulses_page,
...
#region Falling
	...
	create_simple_slider("Velocidade máxima de queda", 10, 1200, 1, JUMP_STATS, "max_fall_speed", falling_page)
	create_label("Modificadores de gravidade", falling_page)
	create_simple_slider("Multiplicador de gravidade na queda", 1, 2, 0.1, JUMP_STATS, "gravity_fall_multiplier", falling_page,
		"Altera o coportamento da gravidade em um pernsonagem em queda, recomendado para q não passe a sensação que está flutuando.")
	create_simple_slider("Multiplicador para corte do pulo", 0, 1, 0.01, JUMP_STATS, "jump_cut_multiplier", falling_page,
...
#region Apex
	...
	create_simple_slider("Multiplicador de gravidade no ápice", 1, 3, 0.01, JUMP_STATS, "gravity_apex_multiplier", apex_page,
		"Diminui a velocidade de queda do personagem enquando estiver no ápice do pulo.")
	create_simple_slider("Multiplicador de velocidade no ápice", 1, 3, 0.01, JUMP_STATS, "apex_speed_multiplier", apex_page,
		"Aumenta a velocidade horizontal do personagem enquanto estiver no ápice do pulo.")
	create_simple_slider("Margem de ápice", 0, 100, 1, JUMP_STATS, "apex_margin", apex_page,
...
#region Dash Page
	...
	create_toggle_button("Habilitar dash", DASH_STATS, "enable_dash", dash_page)
...
#region Impulse
	...
	create_simple_slider("Força do dash", 10, 1000, 1, DASH_STATS, "dash_force", dash_impulse_page)
	create_label("Controles direcionais", dash_impulse_page)
	create_toggle_button("Dash com uma direção", DASH_STATS, "one_directional_dash", dash_impulse_page,
		"Quando desabilitado, permite o jogador executar dash em 8 direções diferentes.")
	create_toggle_button("Salvar última horizontal", DASH_STATS, "save_last_horizontal", dash_impulse_page,
...
#region Timers
	...
	create_simple_slider("Tempo do dash", 0.1, 1, 0.01, DASH_STATS, "dash_time", dash_timers)
	create_simple_slider("Cooldown do dash", 0.1, 1, 0.01, DASH_STATS, "dash_cooldown", dash_timers,
...
#region Wall Slide
	...
	create_toggle_button("Habilitar deslize na parede", WALL_SLIDE_STATS, "enable_wall_slide", wall_slide_page)
	create_observer("double_jump", create_toggle_button("Atualizar pulo duplo", WALL_SLIDE_STATS, "refresh_double_jump", wall_slide_page,
		"Quando habilitado, atualiza o pulo duplo do personagem, possibilitando executar sempre que pular de uma parede."))
	create_simple_slider("Velocidade máxima de deslize", 1, 600, 1, WALL_SLIDE_STATS, "max_wall_slide_velocity", wall_slide_page)
	create_simple_slider("Fricção da parede", 0, 10, 1, WALL_SLIDE_STATS, "wall_friction", wall_slide_page,
...
#region Wall Jump
	...
	create_toggle_button("Habilitar pulo na parede", WALL_JUMP_STATS, "enable_wall_jump", wall_jump_page)
	create_compound_slider("Vetor do pulo", 0, 500, 0, 1000, 1, WALL_JUMP_STATS, "wall_jump_vector", wall_jump_page,
		"Diração e intensidade nas quais o pulo na parede é feito.")
	#create_simple_slider("Tempo de tolerância para pulo", 0, 0.5, 0.01, WALL_JUMP_STATS, "wall_jumping_grace_time", wall_jump_page)
	create_simple_slider("Multiplicador de velocidade de ejeção", 0, 5, 0.1, WALL_JUMP_STATS, "jump_off_wall_multiplier", wall_jump_page,
		"Multiplica a velocidade da cordenada x no vetorde pulo na parede quando o jogador pula na direção oposta da parede.")
#endregion
#endregion
...
#region Melee Page
	...
	create_toggle_button("Habilitar ataque corpo a corpo", MELEE_ATTACK_STATS, "enable_melee_attack", melee_page)
	create_simple_slider("Dano corpo a corpo", 0, 5, 1, MELEE_ATTACK_STATS, "melee_damage", melee_page)
...
#region Timers Page
	...
	#create_simple_slider("Tempo do ataque", 0.01, 0.5, 0.01, MELEE_ATTACK_STATS, "swing_time", melee_timers_page)
	create_simple_slider("Buffer de input de ataque", 0.01, 0.5, 0.01, MELEE_ATTACK_STATS, "swing_buffer", melee_timers_page,
		"Determina o tempo, em segundos, que a ação de ataque pode ser identificada como input mesmo quando não estiver recarregada.")
	create_simple_slider("Cooldown de ataque", 0.01, 2, 0.01, MELEE_ATTACK_STATS, "swing_cooldown", melee_timers_page,
...
#region Knockback Page
	...
	create_simple_slider("Força de knockback", 0, 500, 1, MELEE_ATTACK_STATS, "knockback_force", melee_knockback_page,
		"Força exercida pelos acertos de ataques em inimigos.")
	create_simple_slider("Recuo de ataque", 0, 200, 1, MELEE_ATTACK_STATS, "swing_recoil", melee_knockback_page,
		"Força exercida sobre o jogador quando não acerta os ataques.")
	create_simple_slider("Recuo de acerto", 0, 300, 1, MELEE_ATTACK_STATS, "strike_recoil", melee_knockback_page,
		"Força exercida sobre o jogador quando acerta os ataques.")
	create_simple_slider("Força do pogo", 0, 1000, 1, MELEE_ATTACK_STATS, "pogo_force", melee_knockback_page,
...
#region Ranged Page
	...
	create_toggle_button("Habilitar ataque à distância", RANGED_ATTACK_STATS, "enable_ranged_attack", ranged_page)
	create_simple_slider("Dano", 1, 5, 1, PROJECTILE_STATS, "damage", ranged_page)
...
#region Projectile Page
	...
	create_simple_slider("Tempo de vida", 0.1, 5, 0.1, PROJECTILE_STATS, "life_time", projectile_page,
		"Tempo que o projétil permanecerá ativo antes de ser destruído.")
	create_simple_slider("Vida do projétil", 1, 5, 1, PROJECTILE_STATS, "life", projectile_page,
		"Quantas vezes o projétil poderá atingir algo antes de ser destruída.")
	create_simple_slider("Velocidade", 10, 800, 1, PROJECTILE_STATS, "speed", projectile_page)
	create_simple_slider("Gravidade", 0, 2.5, 0.01, PROJECTILE_STATS, "gravity", projectile_page,
		"Taxa de influência da gravidade sobre o projétil.")
	create_simple_slider("Força de knockback", 0, 500, 10, PROJECTILE_STATS, "knockback_force", projectile_page,
		"Força exercida pelos acertos de ataques em inimigos.")
#endregion
...
#region Cannon Page
	...
	#create_simple_slider("Tempo de recarga", 0.01, 2, 0.01, CANNON_STATS, "reload_time", cannon_page)
	create_simple_slider("Coice", 0, 200, 1, CANNON_STATS, "recoil", cannon_page,
		"Força exercida sobre o jogador quando realizar um ataque à distância parado.")
	#create_simple_slider("Munição máxima", -1, 5, 1, CANNON_STATS, "max_ammo", cannon_page,
...
#region Directions Page
	...
	create_toggle_button("4 direções", RANGED_ATTACK_STATS, "_4_directions", directions_page,
		"Quando habilitado, permite executar ataques à distância em 4 direções.")
	create_toggle_button("8 direções", RANGED_ATTACK_STATS, "_8_directions", directions_page,
...
#region Camera Page
	...
	create_compound_slider("Look ahead", 0, 160, 0, 160, 1, CAMERA_STATS, "look_ahead", camera_page,
		"Distância na qual a câmera irá avançar para frente do jogador, acompanhando seus movimentos.")
	create_simple_slider("Zona morta para câmera seguir", 32, 320, 1, CAMERA_STATS, "camera_follow_threshold", camera_page,
		"Zona onde o jogador pode se movimentar livremente sem que a câmera avance para frente.")
	create_toggle_button("Deslocar com velocidade", CAMERA_STATS, "increase_with_speed", camera_page,
		"Quando habilitado, a distância de avanço da câmera varia a depender da velocidade.")
	create_compound_slider("Amortecimento", 0, 16, 0, 16, 1, CAMERA_STATS, "damping", camera_page,
		"Velocidade de arraste da câmera.")
	create_simple_slider("Deslocamento do nível do chão", 0, 160, 1, CAMERA_STATS, "floor_level_offset", camera_page,
		"Eleva a câmera, concdendo mais espaço para exibir o cenário.")
	create_toggle_button("Chão estável", CAMERA_STATS, "stable_floor", camera_page,
	...
	create_simple_slider("Olhar ao redor", 0, 320, 1, CAMERA_STATS, "look_around_amount", camera_page,
