...
#region Knockback Page
	...
	create_simple_slider("Força de knockback", 0, 500, 1, stats.MELEE_ATTACK_STATS, "knockback_force", melee_page,
	...
	create_simple_slider("Força do pogo", 0, 1000, 1, stats.MELEE_ATTACK_STATS, "pogo_force", melee_page,
