...
#region Wall Slide
	...
	create_simple_slider("Velocidade máxima de deslize", 200, 600, 1, stats.WALL_SLIDE_STATS, "max_wall_slide_velocity", wall_slide_page)
	create_simple_slider("Fricção da parede", 0, 10, 0.1, stats.WALL_SLIDE_STATS, "wall_friction", wall_slide_page,
...
#region Wall Jump
	...
	create_simple_slider("Multiplicador de velocidade de ejeção", 1, 10, 0.1, stats.WALL_JUMP_STATS, "jump_off_wall_multiplier", wall_jump_page,
